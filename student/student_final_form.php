...
<?php include 'backend/getdocuments.php'; ?>
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <img src="<?='../images/'.$row['photo']?>"
                            onerror="this.src='http://via.placeholder.com/150x200'" srcset="" width="150" height="200">
                    </div>
    ...
    <button type="submit" name="1" size="4" id="<?=$roll?>" class="btn btn-info btn-lg" style="margin-left: 40%"
        onclick="finalalert(this.id)"><a href="index.php">Submit</a></button>
